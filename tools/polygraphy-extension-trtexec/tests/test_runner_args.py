...
class TestTrtexecRunnerArgs:
    ...
    def test_use_cuda_graph(self, trtexec_runner_args):
        trtexec_runner_args.parse_args([ONNX_MODELS_PATH["identity"], "--use-cuda-graph"])
    ...
    def test_best(self, trtexec_runner_args):
        trtexec_runner_args.parse_args([ONNX_MODELS_PATH["identity"], "--best"])
    ...
    def test_expose_dma(self, trtexec_runner_args):
        trtexec_runner_args.parse_args([ONNX_MODELS_PATH["identity"], "--expose-dma"])
    ...
    def test_no_data_transfers(self, trtexec_runner_args):
        trtexec_runner_args.parse_args([ONNX_MODELS_PATH["identity"], "--no-data-transfers"])
